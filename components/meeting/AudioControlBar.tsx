...
export default function AudioControlBar({ 
  ...
  return (
    <footer className={cn(
      "fixed bottom-0 left-0 right-0 z-50 h-[80px] bg-[#050508]/90 backdrop-blur-xl border-t border-white/5 flex items-center justify-between px-4 md:px-6 pointer-events-auto transition-all",
      isMobile && "h-[100px] flex-col justify-center gap-2"
    )} role="contentinfo">
