...
export default function ParticipantStage({ isGridView = true, viewMode = 'desktop' }: ParticipantStageProps) {
    ...
    <div className="h-full w-full flex flex-col scrollbar-hide overflow-y-auto">
      <AnimatePresence mode="popLayout">
        {participants.length <= 1 ? (
          ...
          <div className={cn(
             "p-2 md:p-12 transition-all duration-500",
             isGridView ? (
                viewMode === 'mobile' 
                ? "grid gap-2 grid-cols-2 w-full"
